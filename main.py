...
#     """Fetch real-time network metrics from Zabbix."""
#     try:
...
#     """Generate a beautifully formatted PDF report of network status."""
#     try:
#         metrics = fetch_network_metrics()
#         if "error" in metrics:
#             raise HTTPException(status_code=500, detail=metrics["error"])

#         pdf_file_path = "network_report.pdf"
...
#         data = [["Metric Name", "Value"]]  # Table header
...
#         return FileResponse(pdf_file_path, media_type="application/pdf", filename="network_report.pdf")
